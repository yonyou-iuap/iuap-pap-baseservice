 ...
 * 2018年6月19日
 */
public class MssqlInsertSelectiveTemplate extends AbsMssqlTemplate implements SqlTemplate{
	
	private Logger log = LoggerFactory.getLogger(MssqlInsertSelectiveTemplate.class);
