 ...
 * 2018年6月12日
 */
public class GenericExService<T extends DeleteModel>{
    ...
    public Page<T> selectAllByPage(PageRequest pageRequest, SearchParams searchParams) {
        return genericMapperEx.selectAllByPage(pageRequest, searchParams).getPage();
    }
    ...
    public List<T> queryList(Map<String,Object> queryParams){
    	return this.genericMapperEx.queryList(queryParams);
    }
    ...
    public List<Map<String,Object>> queryListByMap(Map<String,Object> params){
    	return this.genericMapperEx.queryListByMap(params);
    }
	...
	public int insert(T entity) {
		if(entity != null) {
			...
			int count = this.genericMapperEx.insert(entity);
	...
	public int update(T entity) {
		if(entity!=null) {
			...
			int count = genericMapperEx.update(entity);
			if(count != 1) {
